        ...
        <div class="col-md-9 bg-white">
          <div class="right">
            <div class="card">
                ...
                <td><?= $job['c_name']?></td>
                <?php if($job['status'] == 1):?>
                <td><a href="status?id=<?= $job['id']?>&status=<?= $job['status']?>" class="btn text-white btn-danger">Unverfied</a></td>
                <?php else:?>
                <td><a href="status?id=<?= $job['id']?>&status=<?= $job['status']?>" class="btn text-white btn-success">Verfied</a></td>
                <?php endif;?>
                <td><a href="delete_job?id=<?= $job['id']?>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
            </table>
