...
<?php
    ...
    if(isset($_GET['id'])){
        $cate_id = $_GET['id'];
        $cateNames = $db->select("SELECT * FROM categories WHERE id='$cate_id'");
        ...
        if(isset($_POST['btn_create'])){
           ...
           $_SESSION['success_cate'] = "Updated category successfully!";
    ...
    <div class="row">
        ...
        <div class="card shadow-sm">
            <form action="" method="POST">
                <div class="card-title"><h5>Update Categories</h5></div>
                <div class="card-body">
                <div class="form-group">
                    <label>Category_name:</label>
                    <input placeholder="Enter type of category" value="<?= $cate_name?>" name="admin_name" type="text" class="form-control">
