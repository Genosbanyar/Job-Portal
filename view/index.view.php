...
<?php 
  ...
  $latest_jobs = $db->select("SELECT * FROM jobs WHERE status='1' ORDER BY created_at DESC LIMIT 5"); 
...
?>
    ...
    Welcome <?php echo $_SESSION['user']; unset($_SESSION['user']);?>
    </div>
    <?php endif;?>
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            ...
            <form method="post" action="search" class="search-jobs-form">
              <div class="row mb-5">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  <button name="search_job" type="submit" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Search Job</button>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 popular-keywords">
                  ...
                  <ul class="keywords list-unstyled m-0 p-0">
                    <?php foreach($trendingKeys as $trendingKey):?>
                    <li><a href="#" class=""><?= $trendingKey['keyword']?></a></li>
                    <?php endforeach;?>
                  </ul>
                </div>
              </div>
...
?>
    <section class="site-section">
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2"><?= $jobsCount?> Job Listed</h2>
          </div>
        </div>
        
        <ul class="job-listings mb-5">
          <?php foreach($latest_jobs as $late_job):?>
          <li class="apply job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a target="_blank" href="job_single?job_id=<?= $late_job['id']?>"></a>
            <div class="job-listing-logo">
              <img src="images/<?= $late_job['c_image']?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </div>

            <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
              <div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
                <h2><?= $late_job['job_title']?></h2>
                <strong><?= $late_job['c_name']?></strong>
              </div>
              <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
                <span class="icon-room"></span> <?= $late_job['job_region']?>
              </div>
              <div class="job-listing-meta">
                <span class="badge badge-<?php if($late_job['job_type'] == "Full Time"){echo "success";}else{echo "danger";}?>"><?= $late_job['job_type']?></span>
              </div>
            </div>
          </li>
          <br>
        ...
        <div class="row pagination-wrap">
          <div class="col-md-6 text-center text-md-left mb-4 mb-md-0">
            <span>Showing <?= $jobsCount?> Jobs</span>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-3 ml-auto">
            <a href="registration" class="btn btn-warning btn-block btn-lg">Sign Up</a>
          </div>
        </div>
      </div>
    </section>
